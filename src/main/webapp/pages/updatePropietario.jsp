              ...
              <div >
                <form action="updatePropietarioList" method="post"  class="form-horizontal mt-5" >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" disabled name="nombres" value='<s:property value="nombres"/>'>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" disabled name="apellidos" value='<s:property value="apellidos"/>'>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    	<jsp:useBean id="cn" class="pe.edu.cibertec.dao.TipoDocumentoDAO" scope="page"></jsp:useBean>
					        <%
					        ResultSet rs = cn.listarTipoDoc();
					        %>
					        ...
					        <select class="form-control" name="tipoDoc">
					            ...
					            while(rs.next()){					              
					            %>
					            	<option value="<%=rs.getString("idTipoDocumento")%>" > <%=rs.getString("descripcion")%> </option>
					            <%
					            }
					            %>
				        	</select>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-2 control-label">Nro de DNI</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" disabled name="documento" value='<s:property value="documento"/>'>
                    </div>
                  </div>
