      ...
      <section class="wrapper">
		<div class="row container ml-3">
          <div class="col-lg-10 mx-auto">
            <section>
             <h2>Agregar nuevo Estado</h2><br>
              <div >
                <form action="registerEstado"  class="form-horizontal mt-5" >
				...
				<form action="listaEstado.jsp">
					<input type="submit" value="Listar Estados" class="btn btn-info" />		
				</form>	
