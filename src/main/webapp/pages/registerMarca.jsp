      ...
      <section class="wrapper">
		<div class="row container ml-3">
          <div class="col-lg-10 mx-auto">
            <section>
             <h2>Agregar nueva Marca</h2><br>
              <div >
                <form action="registerMarca"  class="form-horizontal mt-5" >
				...
				<form action="listaMarca.jsp">
					<input type="submit" value="Listar Marcas" class="btn btn-info" />		
				</form>	
